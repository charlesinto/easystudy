...
class ConversationPage extends StatefulWidget{
  ...
  ConversationPage(this.roomname);
  @override
...
class _ConversationPage extends State<ConversationPage>{
  ...
  Stream<QuerySnapshot> getChatSnapshot(BuildContext context, user){
    ...
    return  _firestore.collection('rooms').where('roomname', isEqualTo: widget.roomname).where('schoolCode', isEqualTo: user['schoolCode']).orderBy('createdAt',descending: false).snapshots();
  }
                      ...
                      children: <Widget>[
                        Bubble(
                          ...
                          child: Column(
                            ...
                            child: Text(snapshot.data.documents[index]['sender'],
                              style: TextStyle(
